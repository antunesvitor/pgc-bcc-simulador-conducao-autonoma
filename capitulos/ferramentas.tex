...
Para a criação do ambiente foi utilizado dois \textit{assets} da Unity Asset Store, ambos fornecem os modelos 3D necessários para montar o ambiente de treino. O primeiro fornece modelos de carros que servirá como o agente (\citeonline{arcade-free-car-unity-asset}) o outro contém diversos modelos necessários para a construção da cidade como ruas, calçadas, prédios, residências, árvores, postes, etc. (\citeonline{city-package-unity-asset})
